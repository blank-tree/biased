    ...
    data() {
      return {
        manifest: [
          ...
          'Das Artefakt und die/der Erschaffer*in sind nicht wissend und dürfen nicht diesen Anschein erwecken.',
